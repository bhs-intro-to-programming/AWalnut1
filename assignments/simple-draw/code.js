...
drawLine(500, 600, width, height, 'red')

drawCircle(width/5, height/5, 100, 'blue');

drawRect(50, 50, 100, 40, 'black');

drawFilledCircle(width - 300, height - 250, 10, 'black');

drawFilledRect(5, height - 10, 45, 15, 'purple');
